...
## Working with Packages
Packages are organised in repositories. The main repositories are:
...
<a href="https://bioconductor.org/"><img src="assets/bioconductor_logo_cmyk.jpg" alt="Bioconductor Logo" width="300" height="auto"></a>
...
R has several basic data types (atomic types) and classes that determine how data is stored and manipulated.

### Basic Data Types in R:

- **Numeric (double)**: Decimal numbers (e.g., 3.14, -2.5)
- **Integer**: Whole numbers (e.g., 42, -7) - marked with `L` suffix
...
### Classes vs Types:
- **Type**: How data is stored in memory (low-level)
- **Class**: How objects behave (high-level, can be customized)
...
[R Lab on Canvas](https://canvas.education.lu.se/courses/37606/files/7018848?module_item_id=1652957&fd_cookie_set=1)

**Use RStudio Server:**
[https://130.235.8.214/rstudio](https://130.235.8.214/rstudio)

<a href="https://about.gitlab.com/blog/git-command-line-on-windows-with-git-bash/"><img src="assets/rstudio_server.png" alt="Git Bash" width="600" height="auto"></a>
